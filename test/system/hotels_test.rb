...
class HotelsTest < ApplicationSystemTestCase
  ...
  test "creating a Hotel" do
    ...
    fill_in "Descripcion", with: @hotel.descripcion
    fill_in "Direccion", with: @hotel.direccion
    fill_in "Email", with: @hotel.email
    fill_in "Fotos", with: @hotel.fotos
    fill_in "Nombre", with: @hotel.nombre
    fill_in "Telefono", with: @hotel.telefono
